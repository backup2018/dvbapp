	...
	def getBlockDevInfo(self, blockdev):
		...
		try:
			...
			if os.path.exists(devpath + "/dev"):
				...
				dev = None
			if getMachineBuild() in ('et1x000', 'vuuno4k', 'vuultimo4k', 'vusolo4k', 'hd51', 'hd52', 'sf4008', 'dm900', 'dm7080', 'dm820', 'gb7252', 'dags7252', 'vs1500', 'h7', 'wetekplay', 'wetekplay2', 'xc7439','u5'):
