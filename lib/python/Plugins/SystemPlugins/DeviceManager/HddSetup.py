...
class HddSetup(Screen):
	if esHD():
		...
		<widget source="menu" render="Listbox" position="10,67" size="820,570" scrollbarMode="showOnDemand">
			<convert type="TemplatedMultiContent">
				{"template": [
 					...
 					MultiContentEntryText(pos = (612,19), size = (225,57), font=0, flags = RT_HALIGN_LEFT|RT_VALIGN_TOP, text = 2),
 					],
 					"fonts": [gFont("RegularHD",22)],
 					"itemHeight": 75
 				}
			</convert>
		</widget>
