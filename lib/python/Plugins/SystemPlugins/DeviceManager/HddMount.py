...
class HddMount(Screen):
	if esHD():
		...
		<widget name="menu" position="30,67" font="RegularHD;20" scrollbarMode="showOnDemand" size="780,570" transparent="1" itemHeight="42" />
		</screen>"""
	else:
		skin = """
...
class HddFastRemove(Screen):
	if esHD():
		...
		<widget name="key_red" position="0,0" zPosition="1" size="210,60" font="RegularHD;20" halign="center" valign="center" backgroundColor="#9f1313" transparent="1" />
		<widget name="key_blue" position="210,0" zPosition="1" size="210,60" font="RegularHD;20" halign="center" valign="center" backgroundColor="#18188b" transparent="1" />
		<widget source="menu" render="Listbox" position="15,82" size="780,570" scrollbarMode="showOnDemand" >
			<convert type="TemplatedMultiContent">
				{"template": [
					MultiContentEntryPixmapAlphaTest(pos = (7,3), size = (72,72), png = 0),
