	...
	def readDisks(self):
		...
		for part in partitions:
			...
			if res and len(res) == 4:
				if (len(res[3]) == 3 and (res[3][:2] == "sd" or res[3][:3] == "hdb")) or (len(res[3]) == 7 and res[3][:6] == "mmcblk" and getMachineBuild() not in ('et1x000', 'vuuno4k', 'vuultimo4k', 'vusolo4k', 'hd51', 'hd52', 'sf4008', 'dm900', 'dm7080', 'dm820', 'gb7252', 'dags7252', 'vs1500', 'h7', 'wetekplay', 'wetekplay2')):
