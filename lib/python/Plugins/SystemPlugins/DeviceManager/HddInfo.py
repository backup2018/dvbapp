...
class HddInfo(ConfigListScreen, Screen):
	if esHD():
		...
		<widget name="key_red" position="0,0" zPosition="1" size="210,60" font="RegularHD;20" halign="center" valign="center" backgroundColor="#9f1313" transparent="1" />
		<widget name="key_green" position="210,0" zPosition="1" size="210,60" font="RegularHD;20" halign="center" valign="center" backgroundColor="#1f771f" transparent="1" />
		<widget name="key_yellow" position="420,0" zPosition="1" size="210,60" font="RegularHD;20" halign="center" valign="center" backgroundColor="#a08500" transparent="1" />
		<widget name="key_blue" position="630,0" zPosition="1" size="210,60" font="RegularHD;20" halign="center" valign="center" backgroundColor="#18188b" transparent="1" />
		<widget font="RegularHD;18" halign="left" name="model" position="30,67" size="780,37" valign="center" />
		<widget font="RegularHD;18" halign="left" name="serial" position="30,112" size="780,37" valign="center" />
		<widget font="RegularHD;18" halign="left" name="firmware" position="30,157" size="780,37" valign="center" />
		<widget font="RegularHD;18" halign="left" name="cylinders" position="30,202" size="780,37" valign="center" />
		<widget font="RegularHD;18" halign="left" name="heads" position="30,247" size="780,37" valign="center" />
		<widget font="RegularHD;18" halign="left" name="sectors" position="30,292" size="780,37" valign="center" />
		<widget font="RegularHD;18" halign="left" name="readDisk" position="30,337" size="780,37" valign="center" />
		<widget font="RegularHD;18" halign="left" name="readCache" position="30,382" size="780,37" valign="center" />
		<widget font="RegularHD;18" halign="left" name="temp" position="30,427" size="780,37" valign="center" />
