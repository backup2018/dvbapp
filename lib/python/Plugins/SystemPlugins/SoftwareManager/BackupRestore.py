...
def InitConfig():
	...
	config.plugins.configurationbackup.backupdirs_default = NoSave(ConfigLocations(default=[eEnv.resolve('${sysconfdir}/enigma2/'),
		'/etc/CCcam.cfg', '/usr/keys/', '/usr/script/', '/etc/enigma2/timers.xml', '/etc/enigma2/LCD4linux*.lcd', '/etc/enigma2/lcd4config', '/etc/wifi/*.wifi',
		'/share/enigma2/picon/', '/usr/share/enigma2/piconlcd/', '/share/enigma2/vfd_icons/', '/share/enigma2/XPicons/',
...
class BackupSelection(Screen):
	skin = """
		<screen name="BackupSelection" position="center,center" size="560,400" title="Select files/folders to backup">
			<ePixmap pixmap="skin_default/buttons/red.png" position="0,340" size="140,40" alphatest="on" />
			<ePixmap pixmap="skin_default/buttons/green.png" position="140,340" size="140,40" alphatest="on" />
			<ePixmap pixmap="skin_default/buttons/yellow.png" position="280,340" size="140,40" alphatest="on" />
